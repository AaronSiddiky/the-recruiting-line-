-- RecruitingLine :: "not hiring at the moment" disposition. Safe to run repeatedly.
--
-- A one-month snooze like "not interested": saving it sets next_follow_up a
-- month out and the queue re-dials the company when that date arrives.
